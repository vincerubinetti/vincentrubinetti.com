...
<?php
  ...
  try {
    ...
    $mail->isSMTP();
    $mail->Host = "{{ site.env.MAIL_HOST }}";
    $mail->SMTPAuth = true;
    $mail->Username = "{{ site.env.MAIL_USERNAME }}";
    $mail->Password = "{{ site.env.MAIL_PASSWORD }}";
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
    $mail->Port = {{ site.env.MAIL_PORT }};
